...
/*            viewType = getProperties().getInt("document.viewtype",
   ...
   /*     JFrame frame = factory.buildViewerFrame();
     ...
     * returned list should still be valid for doing operations on the
     * respective Controller objects
     *
     * @param giveIndex Give this SwingControllers index in the list as an
     * Integer appended to the List
     * @return List of String objects, each representing an open Document's
     * origin. The last element may be an Integer
     */
